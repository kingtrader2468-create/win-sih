...
function InfiniteSpiral({
  ...
  useEffect(() => {
    ...
    const render = (time) => {
      ...
      const desiredAutoSpeed = autoEnabled && visibleRef.current && !reducedMotion.matches && !motionPaused
  ...
  }, [normalizedItems, speed, direction, animationMode, radius, perspective, cardWidth, verticalSpacing, cardsPerTurn, rotation, cardTilt, centerScale, edgeFade, edgeBlur, pauseOnHover]);
  ...
  return (
    ...
    >
      <div className="infinite-spiral__stage" role="list" aria-label="Polar research image gallery">
          ...
          return (
            ...
            >
              <img
                ...
                draggable={false}
                style={{ width: cardWidth, height: cardHeight, objectFit: imageFit, filter: `grayscale(${clamp(grayscale, 0, 1)})` }}
              />
            </Card>
          );
        })}
